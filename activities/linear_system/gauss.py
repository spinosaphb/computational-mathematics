"""
Module for Linear system solutions
"""
import numpy as np

def _find_index(arr: np.ndarray, i) -> np.ndarray:
    """
...
def _swap_row(arr_: np.ndarray, i) -> np.ndarray:
    """
    Troca linhas
    """
    arr = arr_.copy()
    target_index = _find_index(arr, i)
